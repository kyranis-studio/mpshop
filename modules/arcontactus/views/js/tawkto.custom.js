...
* build: 2021-06-03
*  @author Tawk.to
*  @copyright  2021 Tawk.to

*  @license  http://www.apache.org/licenses/LICENSE-2.0
*/
(function(global) {
    global.$_Tawk_AccountKey = tawkToSiteID;
    global.$_Tawk_WidgetId = tawkToWidgetID;
    ...
    (function(u) {
        ...
        try {
            ...
            ia.prototype.updateUnseenMessages = function(a) {
                ...
                if (0 === this.unansweredMessages) {
                    this.pageTitleNotification.off();
                }else if ("min" === r.chatWindowState()){
                    this.show();
                }else{
                    this.pageTitleNotification.on();
                    var evt = new Event('unreadMessagesCountChanged');
            ...
            y.prototype.setDivider = function(a, e, f) {
                ...
                !this.chatContainer.documentRef.getElementById("newMessageDivider") && (g = this.chatContainer.documentRef.getElementById("chatWrapper"), d = new D("newMessageDivider"), d.template = l.escapeTemplateReplacement(e, [{
                    ...
                    }]), d.buildView(), g.insertBefore(d.elementReferrer, f.elementReferrer),
                    !l.chatElementInView(d.elementReferrer) && (b.viewHandler.isMaximized || c.isPopup || c.isEmbedded) && (n = this.chatContainer.documentRef.getElementById("newMessagesBar"))) && (n.className = "visible", b.eventHandler.listen(n, this.clickEvent, function() {
            ...
            K.prototype.bubbleSettingsChanged = function() {
                ...
                b && (b.viewHandler && b.viewHandler.iframeContainer && b.viewHandler.iframeContainer.elementReferrer) && (a && (a.type && "default" !== a.type || this.bubbleContainer.elementReferrer &&
                    this.bubbleContainer.insertCssFile(".bubble-text-color{color:" + (c.chatBubble() ? c.chatBubble().fgc : "#ffffff") + ";}", !0), a && (this.bubbleContainer || (this.bubbleContainer = new N(l.getRandomName(), l.getGenericStyle({
                        ...
                        minheight: "85px",
                        minwidth: "146px"
                    }), Y, "iframe")), this.bubbleContainer.elementReferrer || (b.viewHandler.iframeContainer.elementReferrer.appendChild(this.bubbleContainer.buildView(),
                        !0), this.bubbleContainer.buildIframe(b.MinifiedStyle + c.minStyle(), !0)))), this.createBubble(), this.attachBubbleEvents())
            };
            ...
            var sa = function() {
                ...
                this.popupOnFocusHandler = function() {
                    b && (!u.connected && b.socketManager.isForcedDisconnect() ? b.main.criticalRefresh(r.serverVersion,
                        !1, !0) : (a.hasFocus || (a.active = !0, a.hasFocus = !0, u.connected && b.socketManager.sendToConnector("popupOnFocus", !0)), a.away && u.connected && b.socketManager.sendToConnector("notifySocketStatusUpdate", "online"), a.away = !1))
                };
