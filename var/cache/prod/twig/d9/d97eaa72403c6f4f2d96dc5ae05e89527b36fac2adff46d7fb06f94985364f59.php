  ...
  ";
    ...
    ";
      ...
      <label for=\"";
        ...
        ";
                // line 277
                if (($this->getAttribute($this->getAttribute(($context["form"] ?? null), "vars", []), "label_attr", []) && $this->getAttribute($this->getAttribute($this->getAttribute(($context["form"] ?? null), "vars", []), "label_attr", []), "popover", [], "array"))) {
                    // line 278
                    echo "          ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/macros.html.twig", "/home/mpshop/public_html/src/PrestaShopBundle/Resources/views/Admin/macros.html.twig");
    }
}
